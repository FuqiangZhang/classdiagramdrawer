...
public class DCDAggregation extends DCDRelationship {
	@Override
...
//		
		...
		Shape ponlygon1 = new Polygon();
		int x = (int)rot_X;
		int y = (int) rot_Y;
		
		((Polygon) ponlygon1).addPoint(x, y);
		((Polygon) ponlygon1).addPoint(x - 5, (int) (y +Math.abs(p2.getY()-p1.getY())/(p2.getY()-p1.getY())*8));
		((Polygon) ponlygon1).addPoint(x, (int) (y +Math.abs(p2.getY()-p1.getY())/(p2.getY()-p1.getY())*16));
		((Polygon) ponlygon1).addPoint(x + 5, (int) (y +Math.abs(p2.getY()-p1.getY())/(p2.getY()-p1.getY())*8));
		...
		((Graphics2D) g).fill(ponlygon1);
		g.setColor(Color.black);
		((Graphics2D) g).draw(ponlygon1);
		//
//		
//		Position p1 = pointOnPath.get(pointOnPath.size() - 1);
//		Position p2 = pointOnPath.get(pointOnPath.size() - 2);
...
//		
//		((Polygon) ponlygon1).addPoint(x, y);
//		((Polygon) ponlygon1).addPoint(x - 5, y - 8);
//		((Polygon) ponlygon1).addPoint(x, y -16);
//		((Polygon) ponlygon1).addPoint(x + 5, y - 8);
//		
//		if(lineMe.iskExists()){
//			double r = ((p2.getY()-p1.getY())) * (p2.getY()-p1.getY()) + ((p2.getX()-p1.getX())) * (p2.getX()-p1.getX());
